...
Author: Junjie Yin
Date: 09/23/2024
Description: This file contains the code for a reinforcement learning (RL) agent
             that finds the optimal policy for the zoo-monkey population problem
             using Markov Decision Process (MDP) Value Iteration.
Example Usage: python jyin10code.py 2 4 0.5 -100 0.9
               This means: N_min = 2, N_max = 4, p = 0.5, R_over = -100, gamma = 0.9
"""
